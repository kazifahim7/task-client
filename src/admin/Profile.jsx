...
const Profile = () => {
    ...
    const {data=[]}=useQuery({
        queryKey:[id],
        queryFn:async()=>{
            const response = await axios.get(`http://localhost:7000/singleUser/${id}`)
    ...
    return (
      <div className="flex justify-center items-center">
            <div className="flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 bg-gray-900 dark:bg-gray-50 text-gray-100 dark:text-gray-800">
                <img src={data.imageUrl} alt="" className="w-32 h-32 mx-auto rounded-full bg-gray-500 dark:bg-gray-500 aspect-square" />
                <div className="space-y-4 text-center divide-y divide-gray-700 dark:divide-gray-300">
                    <div className="my-2 space-y-1">
                        ...
                        <h2 className="text-xl font-semibold sm:text-2xl"> Taka : {data.money}</h2>
                        <p className="px-5 text-xs sm:text-base text-gray-400 dark:text-gray-600 capitalize">{data.role}</p>
                    </div>
